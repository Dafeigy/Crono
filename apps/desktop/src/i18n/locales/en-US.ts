export default {
  ...
  response: {
    ...
    timeline: "Timeline",
    formatted: "Response",
    parsedStream: "Stream events",
    raw: "Response (Raw)",
    streamEvents: "{count} stream events",
    ...
    copyExtractedText: "Copy extracted text",
    invalidJsonPath: "Enter a valid JSONPath beginning with $.",
    noExtractedText: "No text matched this JSONPath yet.",
    noStreamContent: "No text content found",
    noStreamContentDescription:
  ...
  command: {
    ...
    copyAsCurlSuccess: "cURL copied to clipboard.",
    copyAsCurlFailed: "Could not copy cURL.",
